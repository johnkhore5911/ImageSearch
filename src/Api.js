...
function Api() {
    ...
    async function SubmitHandler(event){
        ...
        // const ans1 = results[0].urls.full;
        // setImageUrl1(ans1);
        ...
        results.map((result)=>(
            ...
            //     <Image />
            // }
            // const {imageInfo} = result.url.full;
            // <Image image={imageInfo}/>
        ))


        // results.map((result)=>(
            // display={result.urls.full}
            // console.log(result.urls.full)
            // <Image imageUrl={result.urls.full}/>
            //correct
    ...
    // function showImage1(ans){
    //     console.log("inside showImage1")
    //     console.log(ans);
    //     <div>
    ...
    <div className='wrapper' >
        ...
        <div className='cont'>
            <div className='container'>
                    ...
                    {/* <img className='search_icon' onClick={SubmitHandler} src={search} width="38px"></img> */}
